...
func New(opts *Options) (*Overlord, error) {
	...
	o.planMgr.NotifyPlanChanged(o.serviceMgr.PlanChanged)
	...
	o.planMgr.NotifyPlanChanged(o.checkMgr.PlanChanged)

	// Tell log manager about plan updates.
	o.planMgr.NotifyPlanChanged(o.logMgr.PlanChanged)
